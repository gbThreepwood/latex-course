...
\begin{frame}[containsverbatim]{Oppbygging av eit dokument}
	...
	Koden før \mintinline{latex}|\begin{document}| vert kalla ``preamble''. Her importerer ein pakkar som tilbyr ekstra funksjonalitet og endrer instillingar som gjeld heile dokumentet.
		...
		\mintinline{latex}|\documentclass[10pt,a4paper]{article}| velger dokumentklasse, og setter enkelte instillingar som gjeld for heile dokumentet. Dette har betydning både for korleis dokumented ser ut, og kva kommandoar som er tilgjengelig.
	...
	\begin{frame}[containsverbatim]{Oppbygging av eit dokument}
		...
		\mintinline{latex}|\usepackage[T1]{fontenc}| velger kva type skriftkoding (font encoding) som skal nyttast. Merk at dette er ikkje det samme som å velga skrifttype, det handlar om kva \textit{type} skrifttypar som skal vera tigjengeleg. Denne pakken er nesten alltid med.
